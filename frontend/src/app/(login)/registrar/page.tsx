...
export default function Registrar(){
    ...
    return (
        <div className="flex gap-12 mx-24 mt-16 justify-center">
        ...
        className="flex flex-col border-2 rounded-xl place-items-center w-4/12  justify-center justify-evenly">
            ...
            <div className="flex flex-col">
                <label htmlFor="nome" className="ml-1 font-medium">Nome</label>
                <input type="text" name="nome" id="nome" 
                placeholder="Nome completo" className="border-2 h-12 rounded-xl p-1.5 w-80"/>
            </div>

            <div className="flex flex-col pt-4">
                <label htmlFor="email" className="ml-1 font-medium">E-mail</label>
                <input type="email" name="email" id="email" 
                placeholder="E-mail" className="border-2 h-12 rounded-xl p-1.5 w-80"/>
            </div>

            <div className="flex flex-col pt-4">
                <label htmlFor="senha" className="ml-1 font-medium">Senha</label>
                <input type="password" name="senha" id="senha" 
                placeholder="Senha" className="border-2 h-12 rounded-xl p-1.5 w-80"/>
            </div>

            <div className="flex flex-col pt-4">
                <label htmlFor="senhaConf" className="ml-1 font-medium">Confirme sua senha</label>
                <input type="password" name="senhaConf" id="senhaConf" 
                placeholder="Digite sua senha" className="border-2 h-12 rounded-xl p-1.5 w-80"/>
            </div>
